                ...
                if dist_HA <= bond_dist_HA:
                    for k in self.highENatoms:
                        ...
                        if dist_HB <= Hbond_dist_HB and atA != atB:
                            ...
                            # Calculate the energy of this interaction, and add to the total hydrogen bonding contribution                            e_hbnd = e_hbnd + potHBond(f_dmp_theta, f_dmp_hbnd, c_hbnd_AB, dist_AB)
